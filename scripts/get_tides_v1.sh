...
usage() {
  ...
  echo " [-E <extrapolate_dist>] [-f <granule_name>] [-h]"
  echo " "
  echo "Upper case options are passed to compute_tides_ICESat2_ATL11.py"
...
compute_tides() {
	...
	#echo "interp ${interp}"
	echo "compute_tides_ICESat2_ATL11.py ${this} -D./ -O${out_dir} -T${model} -I${interp}"
	compute_tides_ICESat2_ATL11.py ${this} -D./ -O${out_dir} -T${model} -I${interp}
}
